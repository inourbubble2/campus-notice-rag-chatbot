...
from models.metrics import IngestResult
...
async def _ingest_parsed_rows(rows: List[RowMapping]) -> IngestResult:
    ...
    return IngestResult(embedding_metrics=embedding_metrics)
